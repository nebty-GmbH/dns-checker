...
from .api_views import (
    ...
    DomainDetailAPIView,
    DomainListAPIView,
    DomainSnapshotDetailAPIView,
    DomainSnapshotListAPIView,
    IPWhoisInfoDetailAPIView,
    IPWhoisInfoListAPIView,
)
...
urlpatterns = [
    ...
    # Snapshot endpoints
    path(
        "domains/<str:domain_name>/snapshots/",
        DomainSnapshotListAPIView.as_view(),
        name="domain-snapshots",
    ),
    path(
        "snapshots/<int:snapshot_id>/",
        DomainSnapshotDetailAPIView.as_view(),
        name="snapshot-detail",
    ),
    # WHOIS endpoints
    path("whois/", IPWhoisInfoListAPIView.as_view(), name="whois-list"),
    path(
        "whois/<str:ip_address>/",
        IPWhoisInfoDetailAPIView.as_view(),
        name="whois-detail",
    ),
]
